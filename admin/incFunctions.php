	...
	*/
	...
	function get_tables_info($skip_authentication = false){
		...
		$all_tables = array(
			/* ['table_name' => [table props assoc array] */   
				'orders' => array(
					'Caption' => 'Ordini',
					'Description' => '2.1.8 <DatiDDT>blocco da valorizzare nei casi di fattura "differita" per indicare il documento con cui &#232; stato consegnato il bene (i campi del blocco<br>possono essere ripetuti se la fattura fa riferimento a pi&#249; consegne e quindi a pi&#249; documenti di trasporto)',
					'tableIcon' => 'resources/table_icons/cart_remove.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				),
				'ordersDetails' => array(
					'Caption' => 'Dettaglio Ordini vendita PA',
					'Description' => '2.2 <DatiBeniServizi>blocco sempre obbligatorio contenente natura, qualit&#224; e quantit&#224; dei beni / servizi formanti oggetto dell\'operazione;<br>2.2.1 <DettaglioLinee>blocco sempre obbligatorio contenente le linee di dettaglio del documento (i campi del blocco si ripetono per ogni riga di dettaglio) ;<br>',
				...
				'_resumeOrders' => array(
					...
					'Description' => 'In questa tabella inseriremo le fatture passive, cio&#232; quelle ricevute in formato xml alla Agenzie delle Entrate <br>trasformate in pdf ed inseriremo un archivio in pdf delle fatture emesse, e le ricevute di scarto delle fatture emesse.<br>',
					'tableIcon' => 'table.gif',
					'group' => $tg[0],
					'homepageShowCount' => 1
				),
				...
				'vatRegister' => array(
					'Caption' => 'IscrizioneREA/IVA',
					'Description' => '1.2.4 <IscrizioneREA>blocco da valorizzare nei casi di societ&#224; iscritte nel registro delle imprese ai sensi dell\'art. 2250 del codice civile',
				...
				'addresses_PA' => array(
					'Caption' => 'Altro Indirizzo inf. Bancarie',
					'Description' => '1.2.2 <Sede>blocco sempre obbligatorio contenente i dati della sede del cedente / prestatore;<br>1.4.2 <Sede>blocco contenente i dati fiscali e anagrafici del cessionario/committente',
				...
				'PEC' => array(
					'Caption' => 'Dati x Fattura Elettronica',
					'Description' => 'Contiene i codici univoci e/o pec di Clienti, Fornitori, Multiaziende',
	...
	if(!function_exists('getTableList')){
		function getTableList($skip_authentication = false){
			$arrTables = array(   
				'orders' => 'Ordini',
				'ordersDetails' => 'Dettaglio Ordini vendita PA',
				'_resumeOrders' => 'Resume Orders',
				'products' => 'Articoli Magazzino',
				'firstCashNote' => 'Prima Nota',
				'vatRegister' => 'IscrizioneREA/IVA',
				'companies' => 'Cedente Prestatore',
				'CLIENTI_CESSIONARI_PA' => 'Cessionario Committente PA',
				'creditDocument' => 'Nota Credito',
				'electronicInvoice' => 'Fattura Elettronica PA',
				'countries' => 'Countries',
				...
				'addresses_PA' => 'Altro Indirizzo inf. Bancarie',
				'phones' => 'Phones',
				'PEC' => 'Dati x Fattura Elettronica',
				'contacts_companies' => 'Contacts companies',
				'allegati_PA' => 'Allegati PA',
				'sogg_Terzi_Rapp_PA' => 'Sezioni facoltative PA'
			);
