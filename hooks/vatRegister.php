<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'vatRegister' table. 
	...
	*/
	 ...
	 *     $data['idCompany'], $data['companyName'], $data['tax'], $data['month'], $data['year'], $data['amount']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['idCompany'], $data['companyName'], $data['tax'], $data['month'], $data['year'], $data['amount']
