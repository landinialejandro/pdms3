<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'electronicInvoice' table. 
	...
	*/
	...
	function electronicInvoice_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function electronicInvoice_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function electronicInvoice_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['topic'], $data['currency'], $data['trasmissionFormat'], $data['country']
	...
	*/
	...
	function electronicInvoice_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function electronicInvoice_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['topic'], $data['currency'], $data['trasmissionFormat'], $data['country']
	...
	*/
	...
	function electronicInvoice_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function electronicInvoice_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function electronicInvoice_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function electronicInvoice_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function electronicInvoice_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function electronicInvoice_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function electronicInvoice_batch_actions(&$args){
