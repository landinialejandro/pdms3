<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'mails' table. 
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['kind'], $data['mail'], $data['contact'], $data['company']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['kind'], $data['mail'], $data['contact'], $data['company']
