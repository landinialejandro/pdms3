<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'creditDocument' table. 
	...
	*/
	...
	function creditDocument_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function creditDocument_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function creditDocument_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['incomingTypeDoc'], $data['customerID'], $data['nrDoc'], $data['dateIncomingNote'], $data['customerFirm'], $data['customerAddress'], $data['customerPostCode'], $data['customerTown']
	...
	*/
	...
	function creditDocument_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function creditDocument_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['incomingTypeDoc'], $data['customerID'], $data['nrDoc'], $data['dateIncomingNote'], $data['customerFirm'], $data['customerAddress'], $data['customerPostCode'], $data['customerTown']
	...
	*/
	...
	function creditDocument_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function creditDocument_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function creditDocument_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function creditDocument_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function creditDocument_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function creditDocument_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function creditDocument_batch_actions(&$args){
