<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'town' table. 
	...
	*/
	 ...
	 *     $data['country'], $data['idIstat'], $data['town'], $data['district'], $data['region'], $data['prefix'], $data['shipCode'], $data['fiscCode'], $data['inhabitants'], $data['link']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['country'], $data['idIstat'], $data['town'], $data['district'], $data['region'], $data['prefix'], $data['shipCode'], $data['fiscCode'], $data['inhabitants'], $data['link']
