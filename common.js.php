...
function orders_validateData(){
	...
	/* Field multiOrder_nr_PA can't be empty */
	if($j('#multiOrder_nr_PA').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Numero", close: function(){ /* */ $j('[name=multiOrder_nr_PA]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field tipo_Documento_PA can't be empty */
	if($j('#tipo_Documento_PA').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Tipo Documento PA", close: function(){ /* */ $j('[name=tipo_Documento_PA]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field divisa_PA can't be empty */
	if($j('#divisa_PA').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Divisa PA", close: function(){ /* */ $j('[name=divisa_PA]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field importoTot_Doc_PA can't be empty */
	if($j('#importoTot_Doc_PA').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Importo Totale doc.", close: function(){ /* */ $j('[name=importoTot_Doc_PA]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field causale_PA can't be empty */
	if($j('#causale_PA').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Causale PA", close: function(){ /* */ $j('[name=causale_PA]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Date field data_Ord_PA can't be empty */
	if($j('#data_Ord_PA-dd').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Data dell\'ordine PA", close: function(){ /* */ $j('#data_Ord_PA-dd').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	if($j('#data_Ord_PA-mm').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Data dell\'ordine PA", close: function(){ /* */ $j('#data_Ord_PA-mm').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	if($j('#data_Ord_PA').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Data dell\'ordine PA", close: function(){ /* */ $j('#data_Ord_PA').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function ordersDetails_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field productCode can't be empty */
	if($j('#productCode').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Codice Articolo PA", close: function(){ /* */ $j('[name=productCode]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field QuantityReal can't be empty */
	if($j('#QuantityReal').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Peso riscontrato", close: function(){ /* */ $j('[name=QuantityReal]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field UMRifPeso_PA can't be empty */
	if($j('#UMRifPeso_PA').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> UM PA", close: function(){ /* */ $j('[name=UMRifPeso_PA]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field prezzoUn_PA can't be empty */
	if($j('#prezzoUn_PA').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Prezzo unitario PA", close: function(){ /* */ $j('[name=prezzoUn_PA]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field aliquotaIVA_PA can't be empty */
	if($j('#aliquotaIVA_PA').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Aliquota IVA PA", close: function(){ /* */ $j('[name=aliquotaIVA_PA]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field prezzoTot_PA can't be empty */
	if($j('#prezzoTot_PA').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Prezzo Totale PA", close: function(){ /* */ $j('[name=prezzoTot_PA]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field descrizioneArt_PA can't be empty */
	if($j('#descrizioneArt_PA').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> DescrizioneArt PA", close: function(){ /* */ $j('[name=descrizioneArt_PA]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
}
...
function companies_validateData(){
	...
	/* Field kind can't be empty */
	if($j('#kind').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Kind", close: function(){ /* */ $j('[name=kind]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field idPaese_Ced_PA can't be empty */
	if($j('#idPaese_Ced_PA').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Id Paese ", close: function(){ /* */ $j('[name=idPaese_Ced_PA]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field idCodice_Ced_PA can't be empty */
	if($j('#idCodice_Ced_PA').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Id Codice/P.IVA", close: function(){ /* */ $j('[name=idCodice_Ced_PA]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field codiceFiscale_Ced_PA can't be empty */
	if($j('#codiceFiscale_Ced_PA').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Codice Fiscale PA", close: function(){ /* */ $j('[name=codiceFiscale_Ced_PA]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field denominazione_Ced_PA can't be empty */
	if($j('#denominazione_Ced_PA').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Denominazione Ced PA", close: function(){ /* */ $j('[name=denominazione_Ced_PA]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field regimeFiscalePA can't be empty */
	if($j('#regimeFiscalePA').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Regime Ced. Fiscale PA", close: function(){ /* */ $j('[name=regimeFiscalePA]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field idPaeseVett_PA can't be empty */
	if($j('#idPaeseVett_PA').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> IdPaeseVett PA", close: function(){ /* */ $j('[name=idPaeseVett_PA]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field idFiscaleVet_PA can't be empty */
	if($j('#idFiscaleVet_PA').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> IdFiscaleVettore PA", close: function(){ /* */ $j('[name=idFiscaleVet_PA]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field codFiscVet_PA can't be empty */
	if($j('#codFiscVet_PA').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> CodFiscVet PA", close: function(){ /* */ $j('[name=codFiscVet_PA]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field denominazioneVet_PA can't be empty */
	if($j('#denominazioneVet_PA').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> DenominazioneVet PA", close: function(){ /* */ $j('[name=denominazioneVet_PA]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
}
function CLIENTI_CESSIONARI_PA_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field idPaese_Ces_PA can't be empty */
	if($j('#idPaese_Ces_PA').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> IdPaese_Cessionario PA", close: function(){ /* */ $j('[name=idPaese_Ces_PA]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field idCodice_Ces_PA can't be empty */
	if($j('#idCodice_Ces_PA').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> IdCodice Ces PA", close: function(){ /* */ $j('[name=idCodice_Ces_PA]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field codiceFiscale_Ces_PA can't be empty */
	if($j('#codiceFiscale_Ces_PA').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> CodiceFiscale Ces PA", close: function(){ /* */ $j('[name=codiceFiscale_Ces_PA]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field Denominazione_Ces_PA can't be empty */
	if($j('#Denominazione_Ces_PA').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Denominazione Cessionario PA", close: function(){ /* */ $j('[name=Denominazione_Ces_PA]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field indirizzo_Ces_PA can't be empty */
	if($j('#indirizzo_Ces_PA').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Indirizzo Ces. PA", close: function(){ /* */ $j('[name=indirizzo_Ces_PA]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field CAP_Ces_PA can't be empty */
	if($j('#CAP_Ces_PA').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> CAP Ces. PA", close: function(){ /* */ $j('[name=CAP_Ces_PA]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field comune_Ces_PA can't be empty */
	if($j('#comune_Ces_PA').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Comune Ces. PA", close: function(){ /* */ $j('[name=comune_Ces_PA]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field pr_Ces_PA can't be empty */
	if($j('#pr_Ces_PA').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Provincia Ces. PA", close: function(){ /* */ $j('[name=pr_Ces_PA]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field nazione_Ces_PA can't be empty */
	if($j('#nazione_Ces_PA').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Nazione Ces. PA", close: function(){ /* */ $j('[name=nazione_Ces_PA]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
}
...
function addresses_PA_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
...
function allegati_PA_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function sogg_Terzi_Rapp_PA_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
